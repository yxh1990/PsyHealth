!function(t, s) {
    ...
    jPlayerPlaylist.prototype = {
        ...
        play: function(i) {        	
        	if(typeof(window.playMusicIndex)!="undefined" && typeof(window.playmusicflag)!="undefined")
        	  {
        		 window.playMusicIndex = i;
        		 window.playmusicflag = 1;
        		 //window.currentmp3 = this.playlist[i].mp3;
        		 //console.log(this.playlist[i].mp3);
        		 window.setCurrentmusicCss();
        	  }
        	if(typeof(window.userplaymusicindex)!="undefined")
        	{
        		window.userplaymusicindex = i;
        	}
        ...
        pause: function() {
        	if(typeof(window.playmusicflag)!="undefined") { window.playmusicflag = 2; window.setCurrentmusicCss();}
